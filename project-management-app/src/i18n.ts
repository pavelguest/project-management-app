...
export const messages = {
  [LOCALES.ENGLISH]: {
    // Pages=============================================
    // Auth | Edit
    auth_header_title: `Registration`,
    auth_header_title_autoriz: `Autorization`,
  ...
  [LOCALES.RUSSIAN]: {
    ...
    auth_header_title_autoriz: `Авторизация`,
    ...
    auth_btn: `Зарегистрироваться`,
    auth_btn_autoriz: `Войти`,
